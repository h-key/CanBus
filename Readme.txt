...
NOTICE TO USER:
Please, read this carefully. By using all or any portion of
the CannyLab (hereinafter: The Software) you accept all the terms
...
"Licensor" means Canny LLC, a duly registered company in whose
principal place of business is 47 building 4, Leningradskiy Prospekt,
Moscow, Russia "Licensee" means You or Your Company,
unless otherwise indicated.

"Software" means (a) all of the contents of the files, disk(s), 
CD-ROM(s) or other media or downloaded content with which
this Agreement is provided, including but not limited to
...
and (iii) Software setup files and code samples
(if any); and (b) upgrades, modified versions, updates, additions,
and copies of the Software, if any, licensed to you by the Licensor
